# Copyright (c) 2024 MegaDrage
# Licensed under the MIT license

# This is an nixCats config forked from nixCats kickstart-nvim.
...
{
  description = "A Lua + nixCats vim config";
  ...
  # to the name of the packageDefinitions entry you wish to use as the default.
    defaultPackageName = "nixCats-vim";
  in
